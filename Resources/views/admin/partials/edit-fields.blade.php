            ...
            <div style="height: 0px;" id="collapseOne-{{$lang}}" class="panel-collapse collapse">
                <div class="box-body">
                    <div class='form-group{{ $errors->has("{$lang}[title]") ? ' has-error' : '' }}'>
                        ...
                        <?php $old = isset($page->translate($lang)->title) ? $page->translate($lang)->title : '' ?>
                    ...
                    <div class='form-group{{ $errors->has("{$lang}[slug]") ? ' has-error' : '' }}'>
                        ...
                        <?php $old = isset($page->translate($lang)->slug) ? $page->translate($lang)->slug : '' ?>
                        {!! Form::text("{$lang}[slug]", Input::old("{$lang}[slug]", $old), ['class' => "form-control", 'placeholder' => trans('page::pages.form.slug')]) !!}
                        {!! $errors->first("{$lang}[slug]", '<span class="help-block">:message</span>') !!}
                    </div>
                    <div class='box-body pad'>
                        <?php $old = isset($page->translate($lang)->body) ? $page->translate($lang)->body : '' ?>
